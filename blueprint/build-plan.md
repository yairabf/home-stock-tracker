...
- [ ] 34. **Online grocery store integration scaffold** - provide a repository-owned, fail-closed tutorial and generator for isolated vendor-cart skills that consume the existing grocery MCP contract without changing Home Stock Tracker domain behavior
  ...
  - [ ] 34b. **Fail-closed store-skill scaffold** - generate an isolated starter skill with a non-secret preference registry, validation, overwrite protection, and automated scaffold tests
